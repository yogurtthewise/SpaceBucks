...
static const char *strMainNetDNSSeed[][2] = {
    {"69.85.86.195", "69.85.86.195"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"spacebucks.info", "spacebucks.info"},
	{"spacebucks.org", "server1.spacebucks.org"},
	{"spacebucks.com", "spacebucks.com"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SpaceBucks is probably already running."), addrBind.ToString().c_str());
        else
