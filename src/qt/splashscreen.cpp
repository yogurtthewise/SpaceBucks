    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin and Blakecoin Developers"));
    QString copyrightText2  = QChar(0xA9)+QString(" 2014-infinity ") + QString(tr("Yogurt"));
