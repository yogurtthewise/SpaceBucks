...
const QString BITCOIN_IPC_PREFIX("spacebucks:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click spacebucks: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start spacebucks: click-to-pay handler");
    else
...
{
    // clicking on spacebucks: URLs creates FileOpen events on the Mac:
