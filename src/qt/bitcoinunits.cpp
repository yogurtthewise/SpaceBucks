...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BLC: return QString("SBX");
    case mBLC: return QString("mSBX");
    case uBLC: return QString::fromUtf8("μSBX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BLC: return QString("SpaceBucks");
    case mBLC: return QString("Milli-SpaceBucks (1 / 1,000)");
    case uBLC: return QString("Micro-SpaceBucks (1 / 1,000,000)");
    default: return QString("???");
    }
}
